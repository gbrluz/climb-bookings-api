...
export class Player {
  ...
  toPlainObject() {
    return {
      ...
      rankingPoints: this._rankingPoints,
      totalMatches: this._totalMatches,
      totalWins: this._totalWins,
      winRate: this._winRate,
      isAdmin: this._isAdmin,
      globalRankingPoints: this._globalRankingPoints,
      isProvisional: this._isProvisional,
      provisionalGamesPlayed: this._provisionalGamesPlayed,
      canJoinLeagues: this._canJoinLeagues,
      captainCount: this._captainCount,
      phone: this._phone,
